  ...
  return (
    <>
      ...
      <div className="about container row" id="about">
        <div className="aboutme-contents mt-5 col-7" >
          <h2 className="aboutme-title" data-aos="zoom-in-right">Hi, I&apos;m Joe!</h2>
          <h4 className="aboutme-subtitle fw-bold text-uppercase" data-aos="zoom-in-right">A recent graduate of a Software Engineering Immersive by General Assembly.</h4>
          <div data-aos="zoom-in-right">
            <p className="aboutme-paragraphs mt-3">I previously worked in corporate finance for a period of 5 years, before deciding to take a career break and going on an adventure around the world. Exploring all the beaches, reefs and mountains I could.</p>
            <p className="aboutme-paragraphs">Then along came the pandemic, everybody&apos;s lives changed and the world stopped. This offered something very unique to me. It offered the chance to stop, reset and try something new.</p>
            ...
            <p className="aboutme-paragraphs">Now that I have graduated from the Software Engineering course, I am looking to build on my new skills, grow as a developer and establish myself in an exciting new industry.</p>
