      ...
      <div data-aos="zoom-in-right">
        ...
        <div className="slideShow">
          <div className="d-flex flex-row justify-content-center align-items-center ">
            <a className="project-name"href={carouselData[currentSlide].url} target='_blank' rel="noreferrer"><h3 className="display-3 me-3">{carouselData[currentSlide].name}</h3></a>
