...
function Interests() {
  ...
  return (
    <section className="interests container" id="interests">
      <div className="interests-content" data-aos="zoom-in-left">
        <h1 className="display-1">My Interests</h1>
        <hr className="bg-dark border-5 border-top border-dark"></hr>
        <div>
          <p>When I&apos;m not searching the MDN archives, I enjoy following the football, taking myself on an adventure, listening to music and spending time with my dog, Taz.</p>
          <p>Three (slightly larger) adventures I fancy next are: a snowboarding trip to Japan, some diving in the Galapagos and a return trip to Mexico for those prized tacos.</p>
        ...
        <div className="mt-5 container container-fluid">
          <div className="interest-image-gallery row gy-2 gx-2">
